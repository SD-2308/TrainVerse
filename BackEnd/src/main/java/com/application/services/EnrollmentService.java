...
//	}
	...
	public Optional<Enrollment> checkEnrollment(String courseid, String userid, String role) {
        return enrollmentRepo.findByCourseidAndEnrolleduseridAndEnrolledusertype(courseid, userid, role);
    }
