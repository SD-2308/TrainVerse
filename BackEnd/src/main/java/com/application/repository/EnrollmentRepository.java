...
//	public List<Enrollment> findByEnrolleduserid(String enrolleduserid);
	...
	public List<Enrollment> findByEnrolleduserid(String enrolledUser);
	...
	Optional<Enrollment> findByCourseidAndEnrolleduseridAndEnrolledusertype(String courseid, String enrolleduserid, String enrolledusertype);
